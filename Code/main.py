...
feature_data = object.getFeatures(map_source_directory, CORES, NUMBER_OF_FEATURES, new_markers=False,
								  filename='./numpy_arrays/feature_data_all_threads_final.npy', load_features=True)
